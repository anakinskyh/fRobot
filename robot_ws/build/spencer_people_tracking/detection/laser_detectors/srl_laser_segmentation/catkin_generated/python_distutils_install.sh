...
echo_and_run cd "/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/spencer_people_tracking/detection/laser_detectors/srl_laser_segmentation"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/spencer_people_tracking/detection/laser_detectors/srl_laser_segmentation/setup.py" \
    build --build-base "/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/build/spencer_people_tracking/detection/laser_detectors/srl_laser_segmentation" \
    install \
    $DESTDIR_ARG \
