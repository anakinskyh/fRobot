...
if("TRUE" STREQUAL "TRUE")
  set(moveit_ros_warehouse_SOURCE_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/moveit_ros/warehouse)
  set(moveit_ros_warehouse_DEVEL_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/devel)
  ...
  set(moveit_ros_warehouse_INSTALL_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/install)
...
if(NOT "/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/moveit_ros/warehouse/warehouse/include " STREQUAL " ")
  set(moveit_ros_warehouse_INCLUDE_DIRS "")
  set(_include_dirs "/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/moveit_ros/warehouse/warehouse/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_ros_warehouse' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_ros_warehouse' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/moveit_ros/warehouse/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
