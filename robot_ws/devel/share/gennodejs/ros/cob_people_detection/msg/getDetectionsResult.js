...
class getDetectionsResult {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = cob_perception_msgs.msg.DetectionArray.serialize(obj.detections, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new getDetectionsResult();
    // Deserialize message field [detections]
    tmp = cob_perception_msgs.msg.DetectionArray.deserialize(buffer);
    data.detections = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
      buffer: buffer
