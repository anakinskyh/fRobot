...
if("FALSE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/devel)
  ...
  set(robot_sim_INSTALL_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'anakin <anakin@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/install/${idir}'.  Ask the maintainer 'anakin <anakin@todo.todo>' to fix it.")
    endif()
