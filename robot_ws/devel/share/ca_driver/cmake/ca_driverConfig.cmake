...
if("TRUE" STREQUAL "TRUE")
  set(ca_driver_SOURCE_PREFIX /home/anakin/Workspace/Robot/robot_ws/src/create_autonomy/ca_driver)
  set(ca_driver_DEVEL_PREFIX /home/anakin/Workspace/Robot/robot_ws/devel)
  ...
  set(ca_driver_INSTALL_PREFIX /home/anakin/Workspace/Robot/robot_ws/install)
...
if(NOT "/home/anakin/Workspace/Robot/robot_ws/src/create_autonomy/ca_driver/include " STREQUAL " ")
  set(ca_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/anakin/Workspace/Robot/robot_ws/src/create_autonomy/ca_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anakin/Workspace/Robot/robot_ws/src/create_autonomy/ca_driver/${idir}'.  Ask the maintainer 'Jacob Perron <jperron@sfu.ca>' to fix it.")
    endif()
...
set(depends "ca_description;ca_msgs;diagnostic_msgs;diagnostic_updater;geometry_msgs;nav_msgs;roscpp;sensor_msgs;std_msgs;tf")
