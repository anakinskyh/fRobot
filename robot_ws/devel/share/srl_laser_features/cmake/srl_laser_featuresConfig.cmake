...
if("TRUE" STREQUAL "TRUE")
  set(srl_laser_features_SOURCE_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/spencer_people_tracking/detection/laser_detectors/srl_laser_features)
  set(srl_laser_features_DEVEL_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/devel)
  ...
  set(srl_laser_features_INSTALL_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/install)
...
if(NOT "/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/spencer_people_tracking/detection/laser_detectors/srl_laser_features/include " STREQUAL " ")
  set(srl_laser_features_INCLUDE_DIRS "")
  set(_include_dirs "/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/spencer_people_tracking/detection/laser_detectors/srl_laser_features/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'srl_laser_features' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Timm Linder <linder@informatik.uni-freiburg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'srl_laser_features' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/spencer_people_tracking/detection/laser_detectors/srl_laser_features/${idir}'.  Ask the maintainer 'Timm Linder <linder@informatik.uni-freiburg.de>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND srl_laser_features_EXPORTED_TARGETS ${${srl_laser_features_dep}_EXPORTED_TARGETS})
endforeach()
