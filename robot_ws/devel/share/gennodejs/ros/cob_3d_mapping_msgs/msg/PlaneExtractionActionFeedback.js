...
class PlaneExtractionActionFeedback {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = PlaneExtractionFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new PlaneExtractionActionFeedback();
    ...
    tmp = PlaneExtractionFeedback.deserialize(buffer);
