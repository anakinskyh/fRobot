...
class AcquireObjectImageAction {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = AcquireObjectImageActionGoal.serialize(obj.action_goal, bufferInfo);
    // Serialize message field [action_result]
    bufferInfo = AcquireObjectImageActionResult.serialize(obj.action_result, bufferInfo);
    // Serialize message field [action_feedback]
    bufferInfo = AcquireObjectImageActionFeedback.serialize(obj.action_feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new AcquireObjectImageAction();
    // Deserialize message field [action_goal]
    tmp = AcquireObjectImageActionGoal.deserialize(buffer);
    data.action_goal = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_result]
    tmp = AcquireObjectImageActionResult.deserialize(buffer);
    data.action_result = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_feedback]
    tmp = AcquireObjectImageActionFeedback.deserialize(buffer);
