...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_bumper2pc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anakin/Workspace/Robot/robot_ws/install/${idir}'.  Ask the maintainer 'Jorge Santos Simon <jorge@yujinrobot.com>' to fix it.")
    endif()
