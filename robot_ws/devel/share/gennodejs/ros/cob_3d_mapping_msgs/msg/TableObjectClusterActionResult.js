...
class TableObjectClusterActionResult {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = TableObjectClusterResult.serialize(obj.result, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new TableObjectClusterActionResult();
    ...
    tmp = TableObjectClusterResult.deserialize(buffer);
