...
class TrainObjectAction {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = TrainObjectActionGoal.serialize(obj.action_goal, bufferInfo);
    // Serialize message field [action_result]
    bufferInfo = TrainObjectActionResult.serialize(obj.action_result, bufferInfo);
    // Serialize message field [action_feedback]
    bufferInfo = TrainObjectActionFeedback.serialize(obj.action_feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new TrainObjectAction();
    // Deserialize message field [action_goal]
    tmp = TrainObjectActionGoal.deserialize(buffer);
    data.action_goal = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_result]
    tmp = TrainObjectActionResult.deserialize(buffer);
    data.action_result = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_feedback]
    tmp = TrainObjectActionFeedback.deserialize(buffer);
