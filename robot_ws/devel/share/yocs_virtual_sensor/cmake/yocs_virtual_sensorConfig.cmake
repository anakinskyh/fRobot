...
if("TRUE" STREQUAL "TRUE")
  set(yocs_virtual_sensor_SOURCE_PREFIX /home/anakin/Workspace/Robot/robot_ws/src/yujin_ocs/yocs_virtual_sensor)
  set(yocs_virtual_sensor_DEVEL_PREFIX /home/anakin/Workspace/Robot/robot_ws/devel)
  ...
  set(yocs_virtual_sensor_INSTALL_PREFIX /home/anakin/Workspace/Robot/robot_ws/install)
...
if(NOT "/home/anakin/Workspace/Robot/robot_ws/src/yujin_ocs/yocs_virtual_sensor/include;/usr/include " STREQUAL " ")
  set(yocs_virtual_sensor_INCLUDE_DIRS "")
  set(_include_dirs "/home/anakin/Workspace/Robot/robot_ws/src/yujin_ocs/yocs_virtual_sensor/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_virtual_sensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anakin/Workspace/Robot/robot_ws/src/yujin_ocs/yocs_virtual_sensor/${idir}'.  Ask the maintainer 'Jihoon Lee <jihoonl@yujinrobot.com>' to fix it.")
    endif()
