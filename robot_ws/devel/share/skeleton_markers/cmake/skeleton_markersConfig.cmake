...
if("TRUE" STREQUAL "TRUE")
  set(skeleton_markers_SOURCE_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/skeleton_markers)
  set(skeleton_markers_DEVEL_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/devel)
  ...
  set(skeleton_markers_INSTALL_PREFIX /home/anakin/Workspace/2016/Robot/fRobot/robot_ws/install)
...
if(NOT "/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'skeleton_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anakin/Workspace/2016/Robot/fRobot/robot_ws/src/skeleton_markers/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
...
set(skeleton_markers_EXPORTED_TARGETS "skeleton_markers_generate_messages_cpp;skeleton_markers_generate_messages_eus;skeleton_markers_generate_messages_lisp;skeleton_markers_generate_messages_nodejs;skeleton_markers_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${skeleton_markers_dep}_FOUND)
      find_package(${skeleton_markers_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${skeleton_markers_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
