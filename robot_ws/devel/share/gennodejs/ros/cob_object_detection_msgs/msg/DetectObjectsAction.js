...
class DetectObjectsAction {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = DetectObjectsActionGoal.serialize(obj.action_goal, bufferInfo);
    // Serialize message field [action_result]
    bufferInfo = DetectObjectsActionResult.serialize(obj.action_result, bufferInfo);
    // Serialize message field [action_feedback]
    bufferInfo = DetectObjectsActionFeedback.serialize(obj.action_feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new DetectObjectsAction();
    // Deserialize message field [action_goal]
    tmp = DetectObjectsActionGoal.deserialize(buffer);
    data.action_goal = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_result]
    tmp = DetectObjectsActionResult.deserialize(buffer);
    data.action_result = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_feedback]
    tmp = DetectObjectsActionFeedback.deserialize(buffer);
