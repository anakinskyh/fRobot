...
class RawTurtlebotSensorState {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = _serializer.int16(obj.requested_velocity, bufferInfo);
    // Serialize message field [requested_radius]
    bufferInfo = _serializer.int16(obj.requested_radius, bufferInfo);
    // Serialize message field [requested_right_velocity]
    bufferInfo = _serializer.int16(obj.requested_right_velocity, bufferInfo);
    // Serialize message field [requested_left_velocity]
    bufferInfo = _serializer.int16(obj.requested_left_velocity, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new RawTurtlebotSensorState();
